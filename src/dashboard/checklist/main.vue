...
const ACTION_LIST: string[] = ["Import Runs from sms.bingo in Run Modifications Tab", "Play Next Run in Run Player", "Set Up Bingosync Room (Super Mario Sunshine, Variant: 1 v 1)", "Ask for Player Colors",

...
<script lang="ts">
    ...
    const ACTION_LIST_SUNSHINE: string[] = [
        ...
        'Play Next Run in Run Player',
        'Set Up Bingosync Room (Super Mario Sunshine, Variant: 1 v 1)',
        'Ask for Player Colors',
        'Check if all RTMP streams are loaded correctly',
        "Give Commentators and Runners 'Current Match' Role in Discord",
    ...
    const ACTION_LIST: string[] = [
        ...
        'Set Run Category and Bingomode',
        'Set Runners',
        'Play Run',

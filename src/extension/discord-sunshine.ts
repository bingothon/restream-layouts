...
import {VoiceActivity, VoiceActivitySunshine} from '../../schemas';
import { Configschema } from '../../configschema';

const nodecg = nodecgApiContext.get();

// NodeCG
const log = new nodecg.Logger(`${nodecg.bundleName}:discordSunshine`);
...
// delay in ms
const voiceDelayRep = nodecg.Replicant<number>('voiceDelaySunshine', { defaultValue: 0, persistent: true });
...
const botToken = config.discordSunshine.token;
const botServerID = config.discordSunshine.serverID;
const botCommandChannelID = config.discordSunshine.commandChannelID;
const botVoiceCommentaryChannelID = config.discordSunshine.voiceChannelID;

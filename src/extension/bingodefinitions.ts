const definitions: {[key: string]: string} = {
  ...
  'double anti bingo': 'In double anti bingo, each player selects a row/column/diagonal for their opponent and chooses an additional line for themselves to complete',

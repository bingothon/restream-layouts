<template>
	<div>
		...
		<team-info team-index='0' height='45px' id='ti1'
				   :style="{
		...
		<team-info team-index='1' height='45px' id='ti2'
				   :style="{
            'border': '5px var(--border-color-' + teamColor2 + ') solid',
            'background-image': 'linear-gradient' + '(var(--lighter-main-color), var(--darker-main-color))'}"></team-info>
